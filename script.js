...
(() => {
  ...
  /* =========================================================
     ...
     Default source: data/products.json, sitting next to this
     script. To hand price/stock updates off to a Google Sheet
     instead (no code edits, no redeploy — just edit the sheet):
     ...
     Leave PRODUCTS_SHEET_CSV_URL empty to keep using the local
     JSON file.
     ========================================================= */
